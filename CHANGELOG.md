...
<p align="center">
	...
	<img src="https://img.shields.io/badge/date-Март%2029%202026-green?style=flat-square" alt="Date March 29 2026"/>
...
### ✨ Улучшено:
* **Web UI (Мобайл):** Полностью переработана адаптивность веб-терминала для мобильных устройств (интерактивная клавиатура Termius-style, обработка `100dvh`).
